...
public class QTodo extends com.mysema.query.sql.RelationalPathBase<BTodo> {
    ...
    public void addMetadata() {
        ...
        addMetadata(description, ColumnMetadata.named("DESCRIPTION").withIndex(6).ofType(Types.VARCHAR).withSize(5000).notNull());
        addMetadata(doneAt, ColumnMetadata.named("DONE_AT").withIndex(4).ofType(Types.TIMESTAMP).withSize(23).withDigits(10));
